...
export default function Edit({ result, students, exams, subjects, flash }) {
    ...
    return (
        <AuthenticatedLayout header="Edit Result">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div className="flex justify-end space-x-2 pt-4">
                                ...
                                <Button variant="primary" type="submit" disabled={processing}>Update Result</Button>
                            </div>
                        </form>
                    </div>
                </div>
