...
export default function Index({ results, flash }) {
    ...
    const handleEdit = (result) => {
        router.visit(route('admin.results.edit', result.id));
    };
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-4 flex justify-between items-center">
                        ...
                        <Link href={route('admin.results.create')}>
                            <Button variant="primary">Add New Result</Button>
                        </Link>
                    </div>
            ...
            <Modal show={deleteModal} onClose={() => setDeleteModal(false)} maxWidth="sm">
                <div className="p-6">
                    ...
                    <p className="text-gray-700">
                        ...
                        <strong>{selectedResult?.student?.user?.name}</strong>?
                    </p>
