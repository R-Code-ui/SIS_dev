...
export default function Edit({ assignment, classes, subjects, flash }) {
    ...
    return (
        <TeacherLayout header="Edit Assignment">
                        ...
                        <form onSubmit={handleSubmit} encType="multipart/form-data" className="p-6 space-y-4">
                            ...
                            <div className="mb-4">
                                ...
                                {assignment.file_path && (
                                    <div className="mb-2">
                                        <a href={asset('storage/' . $assignment->file_path)} target="_blank" className="text-green-600 text-sm">Current file</a>
                                    </div>
                                )}
                                <input
                                    type="file"
