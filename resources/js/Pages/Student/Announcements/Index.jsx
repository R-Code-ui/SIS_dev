...
export default function Index({ announcements, filters }) {
    ...
    const [status, setStatus] = useState(safeFilters.status || 'active');
    ...
    const columns = [
        ...
        { key: 'expiry_date', label: 'Expiry Date', render: (item) => item.expiry_date ? new Date(item.expiry_date).toLocaleDateString() : 'Never' },
    ...
    return (
        <StudentLayout header="Announcements">
